...
export default function Hero() {
  const texts = ["Software Developer", "Technology Enthusiast"];
  ...
  return (
    <div className="h-screen relative bg-[#0e0e0e] overflow-hidden flex flex-col items-center justify-center px-4">
      ...
      <GridBeam className="flex items-center justify-center flex-col max-w-lg h-1/2">
        <div>
          <h1
            className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-2 relative z-10 text-center font-recoleta"> Mohd Anas </h1>
          <MorphingText
            texts={texts}
